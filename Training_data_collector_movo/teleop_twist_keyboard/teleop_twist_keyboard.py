...
if __name__=="__main__":
    ...
    recent_rgb = None
    recent_depth = None
    # rospy.Subscriber('/kinect2/qhd/image_color', Image, rgb_image_cb)
    # rospy.Subscriber('/kinect2/sd/image_depth', Image, depth_image_cb)
    ...
    try:
        ...
        while(1):
            ...
            image_msg = rospy.wait_for_message('/kinect2/qhd/image_color', Image)
            depth_msg = rospy.wait_for_message('/kinect2/sd/image_depth',Image)
            ...
            print(key)
            file_name = "../movo_data/movo_"+str(i)+"_"+str(key)+"_"+str(datetime.datetime.now())
            PIL_Image.fromarray(rgb_array).convert("RGB").save(file_name +".png")  # don't need to convert
            np.save(file_name +".npy", depth_array)
            pub.publish(twist)
